...
summon skeleton ~ ~ ~ {Tags:["setLife","podiumPuppet","needSpread"],NoAI:true,Invulnerable:true,Silent:1b,ArmorItems:[{},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:unbreakable":{},"minecraft:dyed_color":16777215}},{id:"minecraft:elytra",count:1,components:{"minecraft:unbreakable":{}}},{id:"minecraft:light_blue_wool",count:1,components:{"minecraft:custom_model_data":1111111}}],ArmorDropChances:[0.085F,0.000F,0.000F,0.000F],active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:9999999,show_particles:0b}]}
