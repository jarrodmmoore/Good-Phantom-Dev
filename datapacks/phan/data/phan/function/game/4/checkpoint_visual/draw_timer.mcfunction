...
execute if score #drawTime value matches 20.. as @e[tag=hasVisualLine,type=marker,tag=checkpoint] at @s if score @s nodeState matches 1.. run function phan:game/4/checkpoint_visual/start_index
