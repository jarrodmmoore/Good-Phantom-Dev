...
execute if score #draw_mode value matches -1 run summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:2,Tags:["setme_v1"]}
