...
execute positioned ~-.5 ~-.5 ~-.5 as @e[tag=ai,type=zombie,dx=1,dy=3,dz=1] unless score @s playerID = #projID value run function phan:game/4/projectile/player_get_hit
