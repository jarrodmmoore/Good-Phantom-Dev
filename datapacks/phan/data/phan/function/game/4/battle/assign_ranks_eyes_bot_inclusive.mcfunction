...
execute as @e[type=mannequin,tag=ai,tag=!vsHomeStretch,scores={racePosCalc=0}] run function phan:game/4/battle/assign_ranks_eyes_get_max
...
execute as @e[type=mannequin,tag=ai,tag=!vsHomeStretch,scores={racePosCalc=0}] if score @s enderEyes = #maxEyes value run function phan:game/4/battle/assign_ranks_eyes_get_rank
