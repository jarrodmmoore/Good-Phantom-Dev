...
execute as @a[tag=playerReservation,scores={finishPos=1}] if score @s vsAddPoints matches 1 run tellraw @a[tag=doneWithIntro] ["",{text:"[",color:"white",bold:true},{translate:"gp.versus.pos.1st",color:"white",bold:true},{text:"]",color:"white",bold:true},{text:" "},{translate:"gp.versus.got_point",with:[{score:{name:"@s",objective:"vsAddPoints"},color:"white",bold:true}],color:"white",bold:true},{text:" -- ",color:"gray"},{selector:"@s",color:"aqua"},{text:"  "},{text:"(",color:"green"},{score:{name:"@s",objective:"KOs"},color:"green",hover_event:{action:"show_text",value:[{translate:"gp.misc.kos",with:[{score:{name:"@s",objective:"KOs"}}],color:"green"}]}},{text:")",color:"green"}]
execute as @a[tag=playerReservation,scores={finishPos=1}] unless score @s vsAddPoints matches 1 run tellraw @a[tag=doneWithIntro] ["",{text:"[",color:"white",bold:true},{translate:"gp.versus.pos.1st",color:"white",bold:true},{text:"]",color:"white",bold:true},{text:" "},{translate:"gp.versus.got_points",with:[{score:{name:"@s",objective:"vsAddPoints"},color:"white",bold:true}],color:"white",bold:true},{text:" -- ",color:"gray"},{selector:"@s",color:"aqua"},{text:"  "},{text:"(",color:"green"},{score:{name:"@s",objective:"KOs"},color:"green",hover_event:{action:"show_text",value:[{translate:"gp.misc.kos",with:[{score:{name:"@s",objective:"KOs"}}],color:"green"}]}},{text:")",color:"green"}]
