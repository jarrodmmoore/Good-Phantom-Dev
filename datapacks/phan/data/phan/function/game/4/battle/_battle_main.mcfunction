...
scoreboard players set #battleQualifiedForDisplay value 0
...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] at @s run function phan:bots/battle/battle_player_tick
...
execute if score #botsEnabled value matches ..0 run function phan:game/4/battle/assign_ranks_eyes
execute if score #botsEnabled value matches 1.. run function phan:game/4/battle/assign_ranks_eyes_bot_inclusive

#handle reset zones
execute if score #botsEnabled value matches ..0 as @e[type=marker,tag=resetZone,scores={versusSpawn=1}] at @s run function phan:game/4/battle/reset_zone
execute if score #botsEnabled value matches 1.. as @e[type=marker,tag=resetZone,scores={versusSpawn=1}] at @s run function phan:game/4/battle/reset_zone_bot_inclusive
...
execute if score #2sec value matches 11 as @e[type=mannequin,tag=ai] run function phan:game/4/objects/ring_collect_bogus
