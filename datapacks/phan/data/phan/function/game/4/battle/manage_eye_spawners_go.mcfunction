...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] run scoreboard players operation #average value += @s racePosDisplay
...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] if score @s racePosDisplay < #average value run tag @s add topHalfPlayers
...
execute if score #eyeSpawnMethod value matches ..0 run tag @e[type=marker,tag=mightSpawnHere] remove mightSpawnHere
...
execute if score #eyeSpawnMethod value matches 1.. run tag @e[type=marker,tag=dontSpawnHere] remove dontSpawnHere

#clean up tags
tag @a[tag=topHalfPlayers] remove topHalfPlayers
execute if score #botsEnabled value matches 1.. run tag @e[type=mannequin,tag=topHalfPlayers] remove topHalfPlayers
