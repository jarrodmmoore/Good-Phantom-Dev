...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] at @s run function phan:bots/bot_set_self_scores_at_start
...
execute if score #vGameType value matches 2 if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] run scoreboard players set @s energy 6
