...
execute if score #botCount value matches 1.. as @e[type=block_display,tag=botController,x=197,y=-11,z=117,dx=1,dy=1,dz=1,scores={versusPoints=1..}] run function phan:game/4/give_crown_to_point_leader_check
