...
#purple color
team join colorPurple @e[type=item_display,tag=setMe,distance=..4]

#glow in assist mode
execute if score #assist_navigation value matches 1.. as @e[type=item_display,tag=setMe,distance=..4] run data merge entity @s {Glowing:1b}

#glow in battle mode
execute if score #assist_navigation value matches ..0 if score #gameState value matches 4 if score #vGameType value matches 2 as @e[type=item_display,tag=setMe,distance=..4] run data merge entity @s {Glowing:1b}
...
execute if score #random value matches 1 run tag @e[type=item_display,tag=setMe,distance=..4] add goUp


#eye gets our eyeSpawnerID
execute if entity @s[tag=vsEyeSpawner] run scoreboard players operation @e[type=item_display,tag=setMe,distance=..4] eyeSpawnerID = @s eyeSpawnerID
scoreboard players set @e[type=item_display,tag=setMe,distance=..4] hitstun 10

#clean up tag
tag @e[type=item_display,tag=setMe,distance=..4] remove setMe
