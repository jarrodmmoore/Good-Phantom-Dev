...
#glow in assist mode
execute if score #assist_navigation value matches 1.. as @e[tag=setMe] run data merge entity @s {Glowing:1b}

#glow in battle mode
execute if score #assist_navigation value matches ..0 if score #gameState value matches 4 if score #vGameType value matches 2 as @e[tag=setMe] run data merge entity @s {Glowing:1b}
...
execute if entity @s[tag=vsEyeSpawner] run scoreboard players operation @e[tag=setMe] eyeSpawnerID = @s eyeSpawnerID
scoreboard players set @e[tag=setMe] hitstun 10
