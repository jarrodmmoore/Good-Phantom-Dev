...
execute if score #botsEnabled value matches 1.. if score @s[tag=itemBox] hitstun matches ..0 positioned ~-1 ~-1 ~-1 if entity @e[type=mannequin,tag=ai,dx=2,dy=2,dz=2] positioned ~1 ~1 ~1 run function phan:game/4/objects/item_box_check_bot
