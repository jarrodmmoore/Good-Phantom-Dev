...
execute if score #ringBoost value matches ..0 if score #vGameType value matches 2 if score #assist_items value matches 1 run scoreboard players add @s[scores={energy=..17}] energy 1
