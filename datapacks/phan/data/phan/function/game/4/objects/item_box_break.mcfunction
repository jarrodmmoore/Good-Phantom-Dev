...
execute as @e[type=marker,tag=itemBoxSpawner,scores={versusSpawn=1}] if score @s boxID = #thisBoxID value run scoreboard players operation @s editArg3 = #BOXRESPAWNTIME value
