...
execute if score #check16relevant value matches 1 if entity @s[tag=posCalc] as @e[tag=playing,scores={checkFake=15},sort=nearest] if score @s lap = #lapRecursion value run function phan:game/4/race/checkpoint/player_get_position
