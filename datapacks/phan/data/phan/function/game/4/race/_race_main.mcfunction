...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] at @s run function phan:bots/race/race_player_tick
...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai,tag=incrementCheckReal] run function phan:bots/race/checkpoint/increment_player_real
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai,tag=incrementCheckOptional] run function phan:bots/race/checkpoint/increment_player_optional
