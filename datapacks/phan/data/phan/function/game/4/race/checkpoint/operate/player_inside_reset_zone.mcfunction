...
execute if score #vGameType value matches 1 run function phan:game/4/race/respawn
execute unless score #vGameType value matches 1 run function phan:game/4/battle/respawn