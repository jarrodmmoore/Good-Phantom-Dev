...
execute if entity @s[tag=nonPlayer] at @s as @e[type=mannequin,tag=ai,distance=..1] if score @s playerID = #checkID value run function phan:game/4/race/checkpoint/player_get_position
