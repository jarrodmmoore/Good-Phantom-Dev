...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] run scoreboard players add #playerCount value 1
...
execute at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:entity.firework_rocket.blast",targets:"@a[tag=doneWithIntro]",pitch:"1"}
