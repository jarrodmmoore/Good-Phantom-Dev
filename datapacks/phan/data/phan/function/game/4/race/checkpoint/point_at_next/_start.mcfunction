...
execute if entity @s[tag=vsHomeStretch] if loaded ~ ~ ~ facing entity @e[limit=1,type=marker,tag=portalCore,scores={versusSpawn=1}] feet run function phan:game/4/race/checkpoint/point_at_next/_find_angle_difference
