...
execute if score #check18relevant value matches 1 if entity @s[tag=posCalc] as @a[tag=playing,scores={checkFake=17},sort=nearest] if score @s lap = #lapRecursion value run function phan:game/4/race/checkpoint/player_get_position
