...
#score attack
execute if score #spawnScoreAttack value matches 0 run fill 204 -22 112 206 -22 114 air
...
#time attack
execute if score #spawnTimeAttack value matches 0 run fill 207 -22 117 209 -22 119 air
...
#versus
execute if score #spawnPortalRace value matches 0 run fill 204 -22 122 206 -22 124 air
