...
#score attack
summon item 205 -21 113 {Tags:["stay","lobbyProp","modeSelect"],PickupDelay:40,Age:-32768,NoGravity:1b,Item:{id:"minecraft:yellow_wool",count:1,components:{"minecraft:custom_name":'{"translate":"gp.mode_select.score_attack","color":"yellow","italic":false}',"item_model":"gp/object/stardust","minecraft:hide_additional_tooltip":{},"minecraft:custom_data":{modeSelectScore:1b}}}}
execute if score #math value matches ..1 positioned 205 -20 113 positioned ~ ~.4 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp"],alignment:"center",see_through:1b,line_width:1000,billboard:"center",brightness:{sky:0,block:15},text:'[{"translate":"gp.mode_select.score_attack","bold":true,"color":"yellow"},{"text":"\\n"},{"translate":"gp.mode_select.1_to_3_players","bold":false,"color":"gray"}]'}
execute if score #math value matches 2.. positioned 205 -20 113 positioned ~ ~.4 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp"],alignment:"center",see_through:1b,line_width:1000,billboard:"center",brightness:{sky:0,block:15},text:'[{"translate":"gp.mode_select.score_attack","bold":true,"color":"yellow"},{"text":"\\n"},{"translate":"gp.mode_select.1_to_3_players","bold":false,"color":"gray"},{"text":"\\n"},{"translate":"gp.mode_select.play_separately","bold":false,"color":"gray"}]'}
...
execute if score #timeAttackUnlocked value matches 1 run summon item 208 -21 118 {Tags:["stay","lobbyProp","modeSelect"],PickupDelay:40,Age:-32768,NoGravity:1b,Item:{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_name":'{"translate":"gp.mode_select.time_attack","color":"red","italic":false}',"item_model":"gp/object/alarm_clock","minecraft:hide_additional_tooltip":{},"minecraft:custom_data":{modeSelectTime:1b}}}}
execute if score #timeAttackUnlocked value matches 1 positioned 208 -20 118 positioned ~ ~.4 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp"],alignment:"center",see_through:1b,line_width:1000,billboard:"center",brightness:{sky:0,block:15},text:'[{"translate":"gp.mode_select.time_attack","bold":true,"color":"red"},{"text":"\\n"},{"translate":"gp.mode_select.1_player","bold":false,"color":"gray"}]'}

#versus
summon item 205 -21 123 {Tags:["stay","lobbyProp","modeSelect"],PickupDelay:40,Age:-32768,NoGravity:1b,Item:{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_name":'{"translate":"gp.mode_select.versus","color":"light_purple","italic":false}',"item_model":"gp/object/phantom_chest","minecraft:hide_additional_tooltip":{},"minecraft:custom_data":{modeSelectVersus:1b}}}}
execute if score #math value matches ..1 positioned 205 -20 123 positioned ~ ~.4 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp"],alignment:"center",see_through:1b,line_width:1000,billboard:"center",brightness:{sky:0,block:15},text:'[{"translate":"gp.mode_select.versus","bold":true,"color":"light_purple"},{"text":"\\n"},{"translate":"gp.mode_select.1_to_24_players_bots","bold":false,"color":"gray"}]'}
execute if score #math value matches 2.. positioned 205 -20 123 positioned ~ ~.4 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp"],alignment:"center",see_through:1b,line_width:1000,billboard:"center",brightness:{sky:0,block:15},text:'[{"translate":"gp.mode_select.versus","bold":true,"color":"light_purple"},{"text":"\\n"},{"translate":"gp.mode_select.1_to_24_players","bold":false,"color":"gray"},{"text":"\\n"},{"translate":"gp.mode_select.play_together","bold":false,"color":"gray"}]'}
