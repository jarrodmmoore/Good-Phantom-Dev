...
execute if score #goToModeSelect value matches 0 as @a[tag=doneWithIntro] at @s run playsound minecraft:block.portal.travel master @s ~ 100000 ~ 1 1 .1
execute if score #goToModeSelect value matches 0 as @a[tag=doneWithIntro] at @s run playsound minecraft:block.beacon.activate master @s ~ 100000 ~ 100000 1.8
...
execute if score #goToModeSelect value matches 1 as @a[tag=doneWithIntro] at @s run playsound minecraft:entity.enderman.teleport master @s ~ 100000 ~ 100000
