...
execute if score #gameState value matches 2 as @e[type=skeleton,tag=botPreviewEntity] if score @s age = #checkID value at @s run function phan:game/2/bots/bot_preview_entity_perish
