#SLOT 0 - start game immediately (solo player only)
...
execute if entity @s[tag=!hasSlot2,tag=!noInventory] run item replace entity @s hotbar.2 with light_blue_wool[item_model="gp/player_model/phantom_head_ai_1",custom_name=["",{translate:"gp.mode_select.add_bot",color:"white",italic:false,with:[{translate:"gp.bot.difficulty.very_easy",color:"blue"}]}],custom_data={slot2:1b,botmenu:1b}] 1
...
execute if entity @s[tag=!hasSlot3,tag=!noInventory] run item replace entity @s hotbar.3 with light_blue_wool[item_model="gp/player_model/phantom_head_ai_2",custom_name=["",{translate:"gp.mode_select.add_bot",color:"white",italic:false,with:[{translate:"gp.bot.difficulty.easy",color:"aqua"}]}],custom_data={slot3:1b,botmenu:1b}] 1
...
execute if entity @s[tag=!hasSlot4,tag=!noInventory] run item replace entity @s hotbar.4 with light_blue_wool[item_model="gp/player_model/phantom_head_ai_3",custom_name=["",{translate:"gp.mode_select.add_bot",color:"white",italic:false,with:[{translate:"gp.bot.difficulty.normal",color:"green"}]}],custom_data={slot4:1b,botmenu:1b}] 1
...
execute if entity @s[tag=!hasSlot5,tag=!noInventory] run item replace entity @s hotbar.5 with light_blue_wool[item_model="gp/player_model/phantom_head_ai_4",custom_name=["",{translate:"gp.mode_select.add_bot",color:"white",italic:false,with:[{translate:"gp.bot.difficulty.hard",color:"#FFAA00"}]}],custom_data={slot5:1b,botmenu:1b}] 1
...
execute if entity @s[tag=!hasSlot6,tag=!noInventory] run item replace entity @s hotbar.6 with light_blue_wool[item_model="gp/player_model/phantom_head_ai_5",custom_name=["",{translate:"gp.mode_select.add_bot",color:"white",italic:false,with:[{translate:"gp.bot.difficulty.tryhard",color:"red"}]}],custom_data={slot6:1b,botmenu:1b}] 1
