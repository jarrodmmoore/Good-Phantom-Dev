...
#sound
execute as @a[tag=doneWithIntro] at @s run function phan:common/playsound_positionless_low_volume_macro {sound:"minecraft:block.portal.travel",targets:"@s",pitch:"1",volume:".2"}
