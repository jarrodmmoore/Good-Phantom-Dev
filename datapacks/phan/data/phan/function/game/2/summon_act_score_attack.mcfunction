...
$data modify storage phan:level_index model set from storage phan_dream_$(level_id):sa_act_$(act) thumbnail_model
...
execute positioned ~1 ~2.4 ~1 run function phan:level_manager/load/summon_act_preview with storage phan:level_index
