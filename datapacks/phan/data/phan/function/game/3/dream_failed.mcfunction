...
execute if score @s pGameTime matches 1000001 as @a[tag=tellMe] at @s run function phan:common/playsound_positionless_low_volume_macro {sound:"minecraft:custom_sfx/alarm_bell",targets:"@s",pitch:"1",volume:".85"}
