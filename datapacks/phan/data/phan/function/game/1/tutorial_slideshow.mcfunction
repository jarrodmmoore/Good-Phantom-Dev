...
execute if score @s tutorialProgress matches 110..140 run title @s actionbar ["",{translate:"gp.tutorial.press_button_to_glide",with:[{keybind:"key.jump",color:"yellow"}]}]
...
execute if score @s tutorialProgress matches 210..240 run title @s actionbar ["",{translate:"gp.tutorial.hold_button_to_run",with:[{keybind:"key.sprint",color:"yellow"}]}]
