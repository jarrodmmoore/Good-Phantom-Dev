...
execute positioned ~-.5 ~-1.1 ~-.5 if entity @e[type=mannequin,tag=ai,dx=1,dy=3,dz=1] positioned ~.5 ~1.1 ~.5 anchored eyes run function phan:game/1/projectile/hit_index_evil_bot
