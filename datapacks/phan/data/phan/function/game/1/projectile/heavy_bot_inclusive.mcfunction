execute unless entity @s[tag=strongerProjectile] anchored eyes run particle dust{color:[0.6,0.6,1.0],scale:1} ^ ^ ^-1.2 0.05 0.05 0.05 0 1 force
execute unless entity @s[tag=strongerProjectile] anchored eyes run particle dust{color:[0.85,0.85,1.0],scale:1} ^ ^ ^-1.2 0.15 0.15 0.15 0 1 normal
execute if entity @s[tag=strongerProjectile] anchored eyes run particle dust{color:[1.0,0.0,0.0],scale:1} ^ ^ ^-1.2 0.05 0.05 0.05 0 1 force
execute if entity @s[tag=strongerProjectile] anchored eyes run particle dust{color:[1.0,0.2,0.2],scale:1} ^ ^ ^-1.2 0.15 0.15 0.15 0 1 normal
...
execute anchored eyes unless block ^ ^ ^0.25 #phan:not_solid run scoreboard players set #hit value 1
...
execute if entity @s[tag=strongerProjectile] run scoreboard players set #projDamage value 4
...
execute if score #gameState value matches 4 positioned ^ ^ ^ run function phan:game/4/projectile/detect_player_bot_inclusive
execute if score #gameState value matches 4 positioned ^ ^ ^0.5 run function phan:game/4/projectile/detect_player_bot_inclusive

#live
execute if score #hit value matches 0 run tp @s ^ ^ ^1
#die
execute if score #hit value matches 1 anchored eyes positioned ^ ^ ^1 run function phan:game/1/projectile/hit_wall