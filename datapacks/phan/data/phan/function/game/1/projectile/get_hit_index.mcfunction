...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] if score @s playerID = #projID value run tag @s add projectileOwner
...
execute if score #botsEnabled value matches 1.. run tag @e[type=mannequin,tag=ai,tag=projectileOwner] remove projectileOwner
