...
execute if score #test value matches 0 at @s run tp @e[type=armor_stand,tag=setLife,distance=..4] ~ ~ ~ ~ ~
execute if score #test value matches 1 at @s positioned ~ ~-1.1 ~ run tp @e[type=armor_stand,tag=setLife,distance=..4] ~ ~ ~ ~ ~
