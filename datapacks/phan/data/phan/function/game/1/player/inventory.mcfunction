...
execute if entity @s[tag=!hasSlot0,tag=!noInventory] run item replace entity @s hotbar.0 with minecraft:diamond_sword[tooltip_display={hidden_components:[enchantments,attribute_modifiers,unbreakable]},unbreakable={},item_model="gp/item/bite_item",enchantments={"minecraft:sharpness":20,"minecraft:knockback":3},custom_name=["",{keybind:"key.use",color:"white",italic:false},{text:" "},{translate:"gp.game.bite",color:"aqua",italic:false}],attribute_modifiers=[{id:"fastbite",operation:"add_value",type:"attack_speed",amount:0,slot:"mainhand"}],custom_data={slot0:1b,rmb:1b}] 1
