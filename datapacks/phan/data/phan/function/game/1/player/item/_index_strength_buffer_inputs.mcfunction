...
#boost!
execute if score @s bufferInput0 matches 1.. if score @s inputCooldownD matches ..0 if entity @s[scores={energy=3..}] run function phan:game/1/player/item/strong_boost
