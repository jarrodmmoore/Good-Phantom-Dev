#do timer thing
scoreboard players add @s timerAdd 10
...
execute at @s run playsound minecraft:entity.villager.celebrate master @a ~ ~ ~ 1 1.3
...
execute unless score #dontConsumeItem value matches 1 run clear @s red_wool[custom_data~{goldTimer:1b}] 1