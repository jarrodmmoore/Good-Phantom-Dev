...
#^ player motion library looked very promising here, but unfortunately it screws up beyond 1,000 blocks with high strength when moving away from world origin, so that's a bust
