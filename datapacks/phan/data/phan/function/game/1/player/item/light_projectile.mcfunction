...
scoreboard players operation @e[type=armor_stand,tag=setLife,distance=..3] playerID = @s playerID
execute if score #test value matches 0 at @s run tp @e[type=armor_stand,tag=setLife,distance=..3] ^ ^ ^1 ~ ~
execute if score #test value matches 1 at @s positioned ~ ~-1.1 ~ run tp @e[type=armor_stand,tag=setLife,distance=..3] ^ ^ ^1 ~ ~
scoreboard players set @e[type=armor_stand,tag=setLife,distance=..3] lifespan 120
tag @e[type=armor_stand,tag=setLife,distance=..3] remove setLife
