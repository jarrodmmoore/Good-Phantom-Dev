...
execute if score #test value matches 0 at @s run tp @e[tag=setLife,type=armor_stand,distance=..3] ^ ^ ^1 ~ ~
execute if score #test value matches 1 at @s positioned ~ ~-1.1 ~ run tp @e[tag=setLife,type=armor_stand,distance=..3] ^ ^ ^1 ~ ~
