...
execute if score #gameState value matches 4 if entity @s[scores={hurtfulTime=1..,fallFlying=1..},tag=!resistAfterNextDmgTick] run tag @s add playerCancelMomentum
...
#clean up tag
tag @s[tag=resistAfterNextDmgTick] remove resistAfterNextDmgTick
