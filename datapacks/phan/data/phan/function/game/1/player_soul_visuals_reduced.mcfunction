...
summon area_effect_cloud ~ ~ ~ {Tags:["soulNeedsInterp","soulVisualsReduced","summonAfterImages"],custom_particle:{type:"block",block_state:{Name:"air"}},WaitTime:0,Duration:10}
