...
execute if score #10Hz value matches 1 run particle dust{color:[1.0,1.0,1.0],scale:0.9} ~ ~ ~ 0.2 0.2 0.2 1 1 normal
...
execute if score #botsEnabled value matches 1.. if entity @s[tag=!hiddenMusicDisc] if entity @e[type=mannequin,tag=ai,distance=..2] run return run function phan:game/1/objects/ender_eye_collect_bot
