...
execute if score #botsEnabled value matches 1.. if score @s playerID matches 1.. as @e[tag=ai,type=zombie,distance=..3] if score @s playerID = #thisID value run scoreboard players set #noExplode value 1
