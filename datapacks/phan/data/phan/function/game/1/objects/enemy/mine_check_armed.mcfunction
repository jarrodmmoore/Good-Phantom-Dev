...
execute if score #botsEnabled value matches 1.. if score @s playerID matches 1.. as @e[type=mannequin,tag=ai,distance=..3] if score @s playerID = #thisID value run scoreboard players set #noExplode value 1
