...
execute if score @s editArg1 matches 1 if score #botsEnabled value matches ..0 run function phan:game/1/objects/enemy/baby_ghast_aggro
execute if score @s editArg1 matches 1 if score #botsEnabled value matches 1.. run function phan:game/1/objects/enemy/baby_ghast_aggro_bot_inclusive
