...
execute if score #gameState value matches 4 positioned ~ ~-0.6 ~ if entity @a[tag=playing,gamemode=adventure,distance=..2] run function phan:game/4/objects/ring_check_small
#boost arrow visual
