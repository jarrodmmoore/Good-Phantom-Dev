...
execute unless entity @s[type=iron_golem] facing entity 0000007b-0000-00a0-0000-000a0000003c feet rotated ~ 0 if loaded ^ ^ ^0.0007 run summon marker ^ ^ ^0.0007 {UUID:[I;777,0,0,1]}
execute if entity @s[type=iron_golem] facing entity 0000007b-0000-00a0-0000-000a0000003c feet rotated ~ 0 if loaded ^ ^ ^0.00055 run summon marker ^ ^ ^0.00055 {UUID:[I;777,0,0,1]}
