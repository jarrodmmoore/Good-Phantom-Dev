...
#act tag
execute if entity @s[tag=nodeLoadArea0] run tag @e[tag=setMe,distance=..2] add area0Spawn
execute if entity @s[tag=nodeLoadArea1] run tag @e[tag=setMe,distance=..2] add area1Spawn
execute if entity @s[tag=nodeLoadArea2] run tag @e[tag=setMe,distance=..2] add area2Spawn
execute if entity @s[tag=nodeLoadArea3] run tag @e[tag=setMe,distance=..2] add area3Spawn
execute if entity @s[tag=nodeLoadArea4] run tag @e[tag=setMe,distance=..2] add area4Spawn
execute if entity @s[tag=nodeLoadArea5] run tag @e[tag=setMe,distance=..2] add area5Spawn
