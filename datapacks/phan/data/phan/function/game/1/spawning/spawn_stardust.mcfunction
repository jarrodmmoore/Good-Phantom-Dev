...
#single (underwater)
execute if score #inWater value matches 1 unless score @s editArg1 matches 5 run summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:200000,Tags:["checkValid","stay","itemHolder","groupA"],Passengers:[{id:"minecraft:item",NoGravity:1b,Age:-32768,Tags:["checkValid","stay","setMe","stardust","stardustYellow","shootable","groupA"],Item:{id:"minecraft:yellow_wool",count:1,components:{"minecraft:custom_name":{color:"yellow",italic:false,translate:"gp.game.stardust"},"item_model":"gp/object/stardust"}}}]}
#multi (underwater)
execute if score #inWater value matches 1 if score @s editArg1 matches 5 run summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:200000,Tags:["checkValid","stay","itemHolder","groupA"],Passengers:[{id:"minecraft:item",NoGravity:1b,Age:-32768,Tags:["checkValid","stay","setMe","stardust","stardustYellow","shootable","multipack","groupA"],Item:{id:"minecraft:yellow_wool",count:5,components:{"minecraft:custom_name":{color:"yellow",italic:false,translate:"gp.game.stardust"},"item_model":"gp/object/stardust_big"}}}]}
