...
execute if score #brightMines value matches 0 if score #assist_enemies value matches 0 run summon armor_stand ~ ~.5 ~ {Tags:["setLife"],Invulnerable:1b,Marker:1b,NoGravity:1b,Passengers:[{id:"minecraft:item_display",brightness:{sky:10,block:15},Tags:["checkValid","setMe","baddy","groupB","shootable","tntCanHit","artificialHP","needsDisplayHP","startHideHP","enemyHasVehicle","enemySpecialCode","enemyMine"],item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/enemy/mine_black"}}}]}
execute if score #brightMines value matches 0 if score #assist_enemies value matches 1 run summon armor_stand ~ ~.5 ~ {Tags:["setLife"],Invulnerable:1b,Marker:1b,NoGravity:1b,Passengers:[{id:"minecraft:item_display",brightness:{sky:10,block:15},Tags:["checkValid","setMe","baddy","groupB","shootable","tntCanHit","artificialHP","needsDisplayHP","enemyHasVehicle","enemySpecialCode","enemyMine"],item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/enemy/mine_black"}}}]}
execute if score #brightMines value matches 1 if score #assist_enemies value matches 0 run summon armor_stand ~ ~.5 ~ {Tags:["setLife"],Invulnerable:1b,Marker:1b,NoGravity:1b,Passengers:[{id:"minecraft:item_display",brightness:{sky:10,block:15},Tags:["checkValid","setMe","baddy","groupB","shootable","tntCanHit","artificialHP","needsDisplayHP","startHideHP","enemyHasVehicle","enemySpecialCode","enemyMine"],item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/enemy/mine_tech"}}}]}
execute if score #brightMines value matches 1 if score #assist_enemies value matches 1 run summon armor_stand ~ ~.5 ~ {Tags:["setLife"],Invulnerable:1b,Marker:1b,NoGravity:1b,Passengers:[{id:"minecraft:item_display",brightness:{sky:10,block:15},Tags:["checkValid","setMe","baddy","groupB","shootable","tntCanHit","artificialHP","needsDisplayHP","enemyHasVehicle","enemySpecialCode","enemyMine"],item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/enemy/mine_tech"}}}]}
