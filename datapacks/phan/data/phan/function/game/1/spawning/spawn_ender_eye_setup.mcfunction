...
execute if score @s editArg2 matches ..0 run function phan:game/1/spawning/spawn_ender_eye
...
execute if score @s editArg2 matches 1.. if score #checkChunksLoaded value matches 1 run function phan:game/1/spawning/spawn_ender_eye_recursion
execute if score @s editArg2 matches 1.. if score #checkChunksLoaded value matches 0 run tag @s add spawn_failed
#Q: why trails? why not just place a bunch of ender eyes in a row?
