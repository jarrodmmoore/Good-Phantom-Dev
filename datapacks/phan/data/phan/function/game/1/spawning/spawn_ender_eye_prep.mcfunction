...
#here is location
execute if score #tempRecursions value matches 0 if loaded ~ ~ ~ run function phan:game/1/spawning/spawn_ender_eye
...
execute if score #tempRecursions value matches 1.. positioned ^ ^ ^1 run function phan:game/1/spawning/spawn_ender_eye_prep