...
execute if score #inWater value matches 1 run summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:200000,Tags:["checkValid","stay","itemHolder","groupA"],Passengers:[{id:"minecraft:item",NoGravity:1b,Age:-32768,Tags:["checkValid","stay","setMe","stardust","stardustRed","shootable","groupA","representBaddy"],Item:{id:"minecraft:yellow_wool",count:2,components:{"minecraft:custom_name":{color:"red",italic:false,translate:"gp.game.stardust"},"item_model":"gp/object/stardust_red"}}}]}
#Q: red stardust? why?
