...
execute unless entity @e[type=marker,tag=portalCore,distance=..30,scores={eyeSlotAssignment=0..}] run return run tag @s add spawn_failed
#=====
...
scoreboard players add @e[type=marker,tag=portalCore,distance=..30,scores={eyeSlotAssignment=0..},limit=1,sort=nearest] eyeSlotAssignment 1
scoreboard players operation @s editArg2 = @e[type=marker,tag=portalCore,distance=..30,scores={eyeSlotAssignment=0..},limit=1,sort=nearest] eyeSlotAssignment