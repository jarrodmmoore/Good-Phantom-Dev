...
#(a custom mob without a ton of seperate parts riding each other--thank you jesus)
...
execute if score #assist_enemies value matches 1 run scoreboard players set @e[tag=setMe] enemyHP 520
