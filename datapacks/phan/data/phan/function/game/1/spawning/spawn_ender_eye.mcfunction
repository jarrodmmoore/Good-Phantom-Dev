...
execute if score #gameState value matches 4 as @e[type=item_display,tag=setMe,distance=..2] run function phan:game/4/spawning/eye_get_unique_id

#glow in assist mode
execute if score #assist_navigation value matches 1.. run data merge entity @e[limit=1,type=item_display,tag=setMe,distance=..2] {Glowing:1b}
...
execute if score #noShoot value matches 1 run scoreboard players set @e[type=item_display,tag=setMe,distance=..2] hitstun 10
