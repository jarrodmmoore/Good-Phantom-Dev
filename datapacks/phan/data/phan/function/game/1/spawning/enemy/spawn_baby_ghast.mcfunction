...
scoreboard players set @e[type=item_display,tag=setLife2,distance=..2] lifespan 10
...
execute store result score @e[type=item_display,tag=setLife2,distance=..2] editArg2 run random value 1..2
...
tag @e[type=item_display,tag=setLife2,distance=..2] remove setLife2