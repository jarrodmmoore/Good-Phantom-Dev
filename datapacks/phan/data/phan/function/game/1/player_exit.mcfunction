...
execute if score #multiplayer value matches 1 if score #freePlay value matches 0 as @a at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:entity.ender_dragon.hurt",targets:"@s",pitch:"1",volume:"1"}
