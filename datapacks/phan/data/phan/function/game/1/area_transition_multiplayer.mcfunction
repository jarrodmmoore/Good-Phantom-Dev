...
execute if score #pGameTime value matches 100040.. as @e[type=armor_stand,tag=currentSoul] at @s run function phan:game/1/player_soul_fly_up_transition
...
execute if score #pGameTime value matches 100040..100140 if score #followStraightUp value matches 1 as @e[type=armor_stand,tag=currentCamera] at @s run function phan:game/1/area_transition_cam_follow_look
