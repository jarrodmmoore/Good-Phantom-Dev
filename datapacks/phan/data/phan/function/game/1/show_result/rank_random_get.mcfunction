...
execute in overworld run scoreboard players operation #random value = @e[limit=1,type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,sort=random,tag=!tempBan,scores={r=1..4}] r
