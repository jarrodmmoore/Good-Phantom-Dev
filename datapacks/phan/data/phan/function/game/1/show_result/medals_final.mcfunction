...
execute if score #pGameTime value matches 40 if score @s rawTime <= #timeBronze value as @a[tag=tellMe] at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:entity.arrow.hit_player",targets:"@s",pitch:".6",volume:"1"}
...
execute if score #pGameTime value matches 60 if score @s rawTime <= #timeSilver value as @a[tag=tellMe] at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:entity.arrow.hit_player",targets:"@s",pitch:".75",volume:"1"}
...
execute if score #pGameTime value matches 80 if score @s rawTime <= #timeGold value as @a[tag=tellMe] at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:entity.arrow.hit_player",targets:"@s",pitch:".92",volume:"1"}
...
execute if score #pGameTime value matches 100 if score @s rawTime <= #timeDiamond value as @a[tag=tellMe] at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:entity.arrow.hit_player",targets:"@s",pitch:"1",volume:"1"}
execute if score #pGameTime value matches 100 if score @s rawTime <= #timeDiamond value as @a[tag=tellMe] at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:entity.wither.death",targets:"@s",pitch:"1",volume:".8"}
