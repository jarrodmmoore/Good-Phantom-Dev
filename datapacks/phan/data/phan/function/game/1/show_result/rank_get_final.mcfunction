...
execute if score @s prevRandom matches ..0 run function phan:common/playsound_positionless_macro {sound:"minecraft:ui.toast.challenge_complete",targets:"@a[tag=tellMe]",pitch:"1"}
