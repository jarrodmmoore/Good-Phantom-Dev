...
execute if score @s rankArea1 matches 1 run scoreboard players set #bonus1 value 8000
execute if score @s rankArea1 matches 0 run scoreboard players set #bonus1 value 15000
...
execute if score @s rankArea2 matches 1 run scoreboard players set #bonus2 value 8000
execute if score @s rankArea2 matches 0 run scoreboard players set #bonus2 value 15000
...
execute if score @s rankArea3 matches 1 run scoreboard players set #bonus3 value 8000
execute if score @s rankArea3 matches 0 run scoreboard players set #bonus3 value 15000
