#do it for real??
execute if score @s enderChestMenu matches 1 as @a at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:custom_sfx/explode1",targets:"@s",pitch:"1",volume:"1"}
