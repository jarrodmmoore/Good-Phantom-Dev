...
item replace entity @s enderchest.14 with minecraft:red_wool[custom_model_data=1111131,custom_name='{"translate":"gp.mode_select.versus","bold":true,"italic":false,"color":"light_purple"}',lore=['{"text":" "}','{"translate":"gp.mode_select.2_to_24_players","bold":false,"italic":true,"color":"white"}'],custom_data={setModeVersus:1b,adminMenu:1b}]
