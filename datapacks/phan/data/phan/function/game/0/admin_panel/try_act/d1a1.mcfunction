...
execute if score #d1a1Unlocked value matches 0 run playsound minecraft:block.note_block.bass master @s ~ 100000 ~ 100000 1.8
execute if score #d1a1Unlocked value matches 0 run return 0

#play the level
scoreboard players set #freePlay value 1
scoreboard players set #freePlayAct value 1
scoreboard players set #chosenLevel value 1
