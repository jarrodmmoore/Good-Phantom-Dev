...
execute if score #d4a3Unlocked value matches 0 run playsound minecraft:block.note_block.bass master @s ~ 100000 ~ 100000 1.8
execute if score #d4a3Unlocked value matches 0 run return 0
