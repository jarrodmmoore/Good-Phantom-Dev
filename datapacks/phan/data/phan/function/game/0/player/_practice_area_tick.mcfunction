...
execute if entity @s[tag=!hasSlot8a,tag=!noInventory] if entity @s[scores={inputCooldown=..0}] run item replace entity @s hotbar.8 with minecraft:light_blue_dye[custom_model_data=1111120,custom_name='["",{"keybind":"key.use","color":"white","italic":false},{"text":" "},{"translate":"gp.practice.return_to_cabin","color":"red","italic":false}]',custom_data={slot8:1b,rmb:1b,nocooldown:1b}] 1
execute if entity @s[tag=!hasSlot8b,tag=!noInventory] unless entity @s[scores={inputCooldown=..0}] run item replace entity @s hotbar.8 with minecraft:light_blue_dye[custom_model_data=1111121,custom_name='["",{"keybind":"key.use","color":"white","italic":false},{"text":" "},{"translate":"gp.practice.return_to_cabin","color":"gray","italic":false}]',custom_data={slot8:1b,rmb:1b,cooldown:1b}] 1
