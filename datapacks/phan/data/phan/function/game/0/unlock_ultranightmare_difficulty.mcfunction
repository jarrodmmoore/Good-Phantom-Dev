...
tellraw @a[tag=doneWithIntro] ["",{text:"\n"},{translate:"gp.misc.brackets",color:"#00AAFF",with:[{translate:"gp.message.phantom_racer"}]},{text:" "},{translate:"gp.message.ultranightmare_difficulty_unlocked",color:"yellow"},{text:"\n"}]
