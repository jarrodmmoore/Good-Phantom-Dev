...
scoreboard players add #assist_navigation value 1
execute if score #assist_navigation value matches 2.. run scoreboard players set #assist_navigation value 0
