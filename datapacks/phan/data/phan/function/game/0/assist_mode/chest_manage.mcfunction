...
execute if score #assist_enabled value matches 1.. run item replace block ~ ~ ~ container.0 with minecraft:red_dye[custom_model_data=1111201,custom_name='{"translate":"gp.assist.info.scores_will_not_be_saved","with":[{"translate":"gp.assist.assist_mode","color":"#DD33FF","bold":false,"italic":false}],"bold":false,"italic":false}',lore=['{"text":" "}','{"translate":"gp.assist.info.advancements_will_not_be_granted","color":"white","with":[{"translate":"gp.assist.assist_mode","color":"#DD33FF","bold":false,"italic":false}],"bold":false,"italic":false}','{"text":" "}','{"translate":"gp.assist.info.trophies_will_not_be_awarded","color":"white","with":[{"translate":"gp.assist.assist_mode","color":"#DD33FF","bold":false,"italic":false}],"bold":false,"italic":false}'],custom_data={assistMenu:1b}]
