...
item replace block ~ ~ ~ container.8 with red_dye[item_model="gp/inventory/assist_mode/background_connector_3",hide_tooltip={},custom_data={assistMenu:1b}]
...
item replace block ~ ~ ~ container.17 with red_dye[item_model="gp/inventory/assist_mode/background_connector_3",hide_tooltip={},custom_data={assistMenu:1b}]
...
item replace block ~ ~ ~ container.26 with red_dye[item_model="gp/inventory/assist_mode/background_connector_4",hide_tooltip={},custom_data={assistMenu:1b}]
