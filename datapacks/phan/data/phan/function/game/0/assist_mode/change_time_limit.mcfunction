...
scoreboard players add #assist_time_limit value 1
execute if score #assist_time_limit value matches 3.. run scoreboard players set #assist_time_limit value 0
