...
scoreboard players add #assist_race_end_time value 1
execute if score #assist_race_end_time value matches 2.. run scoreboard players set #assist_race_end_time value 0
