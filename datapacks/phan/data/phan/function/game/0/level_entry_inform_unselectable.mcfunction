...
execute if score @s age matches ..50 run title @a[distance=..4,gamemode=!creative] actionbar ["",{"translate":"gp.dream_is_unselectable"}]
execute if score @s age matches 51.. run title @a[distance=..4,gamemode=!creative] actionbar ["",{"translate":"gp.enter_creative_mode_to_edit"}]
