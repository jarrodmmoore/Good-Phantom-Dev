...
execute if score #dream2Opened value matches 0 positioned 204 -1 106 positioned ~.5 ~1.1 ~-.4 run summon item_display ~ ~ ~ {Tags:["lobbyProp","dream2lock"],item_display:"head",item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/object/lock_purple"}}}
#open
...
execute if score #dream4Opened value matches 0 positioned 201 -7 130 positioned ~.5 ~1.1 ~.4 run summon item_display ~ ~ ~ {Tags:["lobbyProp","dream4lock"],item_display:"head",item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/object/lock_green"}}}
...
execute if score #dream5Opened value matches 0 positioned 201 -7 106 positioned ~.5 ~1.1 ~-.4 run summon item_display ~ ~ ~ {Tags:["lobbyProp","dream5lock"],item_display:"head",item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/object/lock_green"}}}
#open
...
execute if score #dream3OpenedB value matches 0 positioned 214 -1 118 positioned ~.4 ~1.1 ~-.6 run summon item_display ~ ~ ~ {Tags:["lobbyProp","dream3lockB"],item_display:"head",item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/object/lock_cyan"}}}
execute as @e[type=item_display,tag=dream3lockB] at @s run tp @s ~ ~ ~ 90 0
execute if score #dream3OpenedA value matches 0 positioned 214 -1 118 positioned ~.4 ~1.1 ~.6 run summon item_display ~ ~ ~ {Tags:["lobbyProp","dream3lockA"],item_display:"head",item:{id:"minecraft:red_wool",count:1b,components:{"item_model":"gp/object/lock_yellow"}}}
