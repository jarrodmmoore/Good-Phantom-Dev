...
summon text_display 204 -5.5 113 {Tags:["lobbyProp"],billboard:"vertical",text:["",{translate:"gp.lobby.intro",bold:true,italic:false,color:"white"}]}
summon text_display 204 -5.5 123 {Tags:["lobbyProp"],billboard:"vertical",text:["",{translate:"gp.lobby.credits",bold:true,italic:false,color:"white"}]}
