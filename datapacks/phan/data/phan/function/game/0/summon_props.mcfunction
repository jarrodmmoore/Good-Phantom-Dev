...
#ROOM 1
#alarm clock
execute positioned 203 -1 139 positioned ~ ~-.3 ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[-10.0f,195.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111112}}]}
#player
execute positioned 204 -2 138 positioned ~.5 ~-.2 ~.75 run summon armor_stand ~ ~ ~ {Tags:["lobbyProp","lobbyPlayer1","levelEntry"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[0.0f,0.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111113}}]}
scoreboard players set @e[tag=lobbyPlayer1] nearPlayer 1
#locket
execute positioned 208 -1 139 positioned ~ ~-.3 ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[0.0f,170.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111122}}]}
#painting on easel
execute positioned 201 -1 136 positioned ~ ~ ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[0.0f,80.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111124}}]}
#title
execute if score #dream1Completed value matches 1.. positioned 204 4 139 positioned ~ ~100 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp","rotateText"],line_width:1000,brightness:{sky:0,block:15},billboard:"fixed",background:16711680,text:'{"text":"\\uE401"}'}
execute as @e[type=text_display,tag=rotateText] at @s run tp @s ~.5 ~-100 ~.4 180 ~
tag @e[tag=rotateText,type=text_display] remove rotateText

#ROOM 2
#alarm clock
execute positioned 206 -1 97 positioned ~ ~-.3 ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[-10.0f,-13.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111112}}]}
#player
execute positioned 204 -2 97 positioned ~.5 ~-.2 ~.5 run summon armor_stand ~ ~ ~ {Tags:["lobbyProp","lobbyPlayer2","levelEntry"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[0.0f,180.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111114}}]}
scoreboard players set @e[tag=lobbyPlayer2] nearPlayer 2
#laptop
execute positioned 209 -1 102 positioned ~ ~-.3 ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[0.0f,-80.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111123}}]}
#command blocks
...
#title
execute if score #dream2Completed value matches 1.. positioned 204 4 97 positioned ~ ~100 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp","rotateText"],line_width:1000,brightness:{sky:0,block:15},billboard:"fixed",background:16711680,text:'{"text":"\\uE402"}'}
execute as @e[type=text_display,tag=rotateText] at @s run tp @s ~.5 ~-100 ~-.4 0 ~
tag @e[tag=rotateText,type=text_display] remove rotateText

#ROOM 3
#alarm clock
execute positioned 223 -1 116 positioned ~ ~-.3 ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[0.0f,75.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111112}}]}
#player
execute positioned 222 -2 118 positioned ~.75 ~-.2 ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp","lobbyPlayer3","levelEntry"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[0.0f,-90.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111115}}]}
scoreboard players set @e[tag=lobbyPlayer3] nearPlayer 3
#blueprint
execute positioned 216 -1 114 positioned ~ ~-.3 ~.5 run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[0.0f,90.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111121}}]}
#title
execute if score #dream3Completed value matches 1.. positioned 223 4 118 positioned ~ ~100 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp","rotateText"],line_width:1000,brightness:{sky:0,block:15},billboard:"fixed",background:16711680,text:'{"text":"\\uE403"}'}
execute as @e[type=text_display,tag=rotateText] at @s run tp @s ~.4 ~-100 ~ 90 ~
tag @e[tag=rotateText,type=text_display] remove rotateText

#ROOM 4
#alarm clock
execute positioned 203 -7 139 positioned ~ ~-.3 ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[-10.0f,195.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111112}}]}
#player
...
#title
execute if score #dream4Completed value matches 1.. positioned 204 -3 139 positioned ~ ~100 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp","rotateText"],line_width:1000,brightness:{sky:0,block:15},billboard:"fixed",background:16711680,text:'{"text":"\\uE404"}'}
execute as @e[type=text_display,tag=rotateText] at @s run tp @s ~.5 ~-100.25 ~.4 180 ~
tag @e[tag=rotateText,type=text_display] remove rotateText

#ROOM 5
#alarm clock
execute positioned 206 -7 97 positioned ~ ~-.3 ~ run summon armor_stand ~ ~ ~ {Tags:["lobbyProp"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:[-10.0f,20.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"minecraft:custom_model_data":1111112}}]}
#player
...
#title
execute if score #dream5Completed value matches 1.. positioned 204 -3 97 positioned ~ ~100 ~ run summon text_display ~ ~ ~ {Tags:["lobbyProp","rotateText"],line_width:1000,brightness:{sky:0,block:15},billboard:"fixed",background:16711680,text:'{"text":"\\uE405"}'}
