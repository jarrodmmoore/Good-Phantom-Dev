...
execute if score #dream3OpenedA value matches 0 if score #invTest value matches 0 run give @s minecraft:yellow_candle[custom_name='{"translate":"gp.lobby.yellow_key","color":"yellow","italic":false,"bold":true}',custom_data={yellowKey:1b}] 1
