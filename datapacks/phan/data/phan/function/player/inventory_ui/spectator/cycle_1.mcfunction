...
execute if score @s joinGame matches -2147483648..2147483647 run item replace entity @s inventory.21 with gray_dye[custom_data={InvUI:21},item_model="gp/inventory/crafting/join_active",custom_name={translate:"gp.inventory.join_game",color:white,bold:true,italic:false},lore=[{text:"/trigger joinGame",color:aqua,italic:true}]]
...
execute if score @s exit matches -2147483648..2147483647 run item replace entity @s inventory.22 with gray_dye[custom_data={InvUI:22},item_model="gp/inventory/crafting/exit_active",custom_name={translate:"gp.inventory.exit",color:white,bold:true,italic:false},lore=[{text:"/trigger exit",color:aqua,italic:true}]]
...
execute if score @s restart matches -2147483648..2147483647 run item replace entity @s inventory.23 with gray_dye[custom_data={InvUI:23},item_model="gp/inventory/crafting/restart_active",custom_name={translate:"gp.inventory.restart",color:white,bold:true,italic:false},lore=[{text:"/trigger restart",color:aqua,italic:true}]]
