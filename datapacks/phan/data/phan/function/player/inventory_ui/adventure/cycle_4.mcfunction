...
#bind drop key
execute if score #slot15 inventoryCheck matches 1 unless score #slot16 inventoryCheck matches 1 if score @s bindDropKey matches -2147483648..2147483647 run scoreboard players set @s bindDropKey 1
#bind swap key
execute if score #slot16 inventoryCheck matches 1 unless score #slot15 inventoryCheck matches 1 if score @s bindSwapKey matches -2147483648..2147483647 run scoreboard players set @s bindSwapKey 1
