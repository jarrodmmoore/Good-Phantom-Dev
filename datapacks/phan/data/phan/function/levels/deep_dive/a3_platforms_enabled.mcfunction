...
execute if score #test value matches 19 as @a[tag=playing,scores={pCurrentArea=3}] at @s run playsound minecraft:block.note_block.hat master @s ~ 100000 ~ 100000 0.8

#power-down sound effect
execute if score #a3_temp_platforms value matches 0 as @a[tag=playing,scores={pCurrentArea=3}] at @s run playsound minecraft:block.beacon.deactivate master @s ~ 100000 ~ 100000 1.75
