...
execute if score #test value matches 19 as @a[tag=playing,scores={pCurrentArea=3}] at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:block.note_block.hat",targets:"@s",pitch:"0.8",volume:".9"}

#power-down sound effect
execute if score #a3_temp_platforms value matches 0 as @a[tag=playing,scores={pCurrentArea=3}] at @s run function phan:common/playsound_positionless_macro {sound:"minecraft:block.beacon.deactivate",targets:"@s",pitch:"1.75",volume:"1"}
