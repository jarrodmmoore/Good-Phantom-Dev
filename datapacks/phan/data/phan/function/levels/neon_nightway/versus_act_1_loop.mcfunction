...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai,x=-3103,y=65,z=225,distance=..5] at @s if block ~ ~-1 ~ red_glazed_terracotta run function phan:levels/neon_nightway/versus_act_1_teleport_bot
