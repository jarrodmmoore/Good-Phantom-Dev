...
execute if score #botsEnabled value matches 1.. as @e[tag=ai,type=mannequin,x=-2224,y=84,z=-2529,distance=..8] at @s if block ~ ~-.2 ~ red_glazed_terracotta run function phan:levels/shattered_city/versus_a1_teleport_1_bot
...
execute if score #botsEnabled value matches 1.. positioned -2275 74 -2531 positioned ~-6 ~ ~-6 run scoreboard players set @e[tag=ai,type=mannequin,dx=16,dy=15,dz=11] levitateState 3
execute if score #botsEnabled value matches 1.. positioned -2217 94 -2428 positioned ~-5 ~ ~-5 run scoreboard players set @e[tag=ai,type=mannequin,dx=9,dy=15,dz=9] levitateState 3
