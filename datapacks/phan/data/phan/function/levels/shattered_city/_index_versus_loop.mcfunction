...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai,scores={levitateState=1..}] run function phan:levels/shattered_city/wind_gust_levitation
