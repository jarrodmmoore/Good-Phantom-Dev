...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai,x=-2584,y=127,z=-2312] at @s at @s if block ~ ~-.2 ~ red_glazed_terracotta run function phan:levels/shattered_city/versus_a2_teleport_1_bot
...
execute if score #botsEnabled value matches 1.. positioned -2394 89 -2333 positioned ~-4 ~ ~-4 run scoreboard players set @e[type=mannequin,tag=ai,dx=8,dy=19,dz=19] levitateState 3
