...
execute if score #botsEnabled value matches 1.. as @e[tag=ai,type=mannequin,x=-2584,y=127,z=-2312] at @s at @s if block ~ ~-.2 ~ red_glazed_terracotta run function phan:levels/shattered_city/versus_a2_teleport_1_bot
...
execute positioned -2395 89 -2333 positioned ~-4 ~ ~-4 run scoreboard players set @a[tag=playing,gamemode=adventure,dx=9,dy=19,dz=19] levitateState 3
execute if score #botsEnabled value matches 1.. positioned -2394 89 -2333 positioned ~-4 ~ ~-4 run scoreboard players set @e[tag=ai,type=mannequin,dx=8,dy=19,dz=19] levitateState 3
...
scoreboard players set @a[scores={lap=2,checkFake=..1}] compassShowTime 14