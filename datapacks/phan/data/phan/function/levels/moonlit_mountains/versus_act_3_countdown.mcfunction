...
execute if score #gameTime value matches 135 run summon falling_block -1958 60 -54 {BlockState:{Name:"minecraft:chiseled_quartz_block"},Time:1}
execute if score #gameTime value matches 135 run summon falling_block -1949 60 -54 {BlockState:{Name:"minecraft:chiseled_quartz_block"},Time:1}