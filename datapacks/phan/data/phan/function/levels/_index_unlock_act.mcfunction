#(no need to data drive this one)

execute if score #chosenLevel value matches 1 run function phan:levels/pastel_palace/unlock_act
execute if score #chosenLevel value matches 2 run function phan:levels/moonlit_mountains/unlock_act
