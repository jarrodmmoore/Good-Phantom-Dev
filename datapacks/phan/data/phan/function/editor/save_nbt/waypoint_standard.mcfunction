#array of 7 ints
data modify entity @s data.WaypointData set value [0,0,0,0,0,0,0,0,0]
...
execute store result entity @s data.WaypointData[7] int 1 run scoreboard players get @s AIBC_spread_x
execute store result entity @s data.WaypointData[8] int 1 run scoreboard players get @s AIBC_spread_z