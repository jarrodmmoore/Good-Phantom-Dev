...
#if we already had something selected, quit out
execute if score @s AIBC_mode matches 3 run return run function phan:editor/panel/ai_waypoint/tools/waypoint_spread/abort
...
scoreboard players set @s AIBC_mode 3
