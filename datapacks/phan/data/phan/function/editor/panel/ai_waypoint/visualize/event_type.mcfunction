...
#1 = force jump
execute if score @s AIBC_event matches 1 unless score @s AIBC_modifier matches ..-1 unless score @s AIBC_modifier matches 1.. run summon area_effect_cloud ~ ~ ~ {Duration:41,CustomNameVisible:1b,CustomName:'["",{"text":"force jump","color":"green"}]'}
...
execute if score @s AIBC_event matches 2 unless score @s AIBC_modifier matches 1..3 unless score @s AIBC_modifier matches -3..-1 run summon area_effect_cloud ~ ~ ~ {Duration:41,CustomNameVisible:1b,CustomName:'["",{"text":"enter flight","color":"green"}]'}
...
execute if score @s AIBC_event matches 2 if score @s AIBC_modifier matches -1 run summon area_effect_cloud ~ ~ ~ {Duration:41,CustomNameVisible:1b,CustomName:'["",{"text":"enter flight, vault upwards","color":"green"}]'}
execute if score @s AIBC_event matches 2 if score @s AIBC_modifier matches -2 run summon area_effect_cloud ~ ~ ~ {Duration:41,CustomNameVisible:1b,CustomName:'["",{"text":"enter flight, vault upwards, spam jump","color":"green"}]'}
execute if score @s AIBC_event matches 2 if score @s AIBC_modifier matches -3 run summon area_effect_cloud ~ ~ ~ {Duration:41,CustomNameVisible:1b,CustomName:'["",{"text":"enter flight & vault upward at ledge","color":"green"}]'}
...
execute if score @s AIBC_event matches -1 unless score @s AIBC_modifier matches 1 run summon area_effect_cloud ~ ~ ~ {Duration:41,CustomNameVisible:1b,CustomName:'["",{"text":"enter improv flight mode","color":"green"}]'}
execute if score @s AIBC_event matches -1 if score @s AIBC_modifier matches 1 run summon area_effect_cloud ~ ~ ~ {Duration:41,CustomNameVisible:1b,CustomName:'["",{"text":"cancel improv flight mode","color":"green"}]'}
