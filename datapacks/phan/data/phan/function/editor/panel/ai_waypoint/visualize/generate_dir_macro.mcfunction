...
$summon area_effect_cloud ~ ~ ~ {Duration:100,Tags:["setDirection","waypointTrail","$(text)"]}
...
scoreboard players operation @e[type=marker,tag=setDirection] AIBC_selected = #test value

#clean up tag
tag @e[type=marker,tag=setDirection] remove setDirection