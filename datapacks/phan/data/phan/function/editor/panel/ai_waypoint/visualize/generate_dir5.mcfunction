...
execute unless score @s AIBC_event matches 10 run data modify storage phan:ai_waypoint text set value "yellow"
execute if score @s AIBC_event matches 10 run data modify storage phan:ai_waypoint text set value "pearl"
