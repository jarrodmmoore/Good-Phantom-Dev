...
execute unless items entity @s weapon.mainhand stick[custom_data~{waypointOptimal:1b}] run return run scoreboard players set @s AIBC_mode 0
...
function phan:editor/panel/ai_waypoint/tools/waypoint_optimal/get_selected_waypoint with storage phan:ai_waypoint