...
tellraw @s ["",{text:" "}]
tellraw @s ["",{text:"/scoreboard players set @e[type=mannequin,tag=ai] botHasItem",color:"dark_aqua","underlined":true,click_event:{action:"suggest_command",command:"/scoreboard players set @e[type=mannequin,tag=ai] botHasItem"}}]
tellraw @s ["",{text:"/scoreboard players set @e[type=mannequin,tag=ai] energy 18",color:"dark_aqua","underlined":true,click_event:{action:"suggest_command",command:"/scoreboard players set @e[type=mannequin,tag=ai] energy 18"}}]
tellraw @s ["",{text:" "}]
