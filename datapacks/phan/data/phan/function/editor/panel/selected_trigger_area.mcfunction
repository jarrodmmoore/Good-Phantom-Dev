...
tellraw @s ["",{translate:"gp.editor.button.set_min_xyz",color:"yellow",bold:false,click_event:{action:"run_command",command:"/function phan:editor/checkpoint/set_min_xyz"},hover_event:{action:"show_text",value:[{translate:"gp.editor.hover.set_min_xyz"}]}}]
tellraw @s ["",{translate:"gp.editor.button.set_max_xyz",color:"yellow",bold:false,click_event:{action:"run_command",command:"/function phan:editor/checkpoint/set_max_xyz"},hover_event:{action:"show_text",value:[{translate:"gp.editor.hover.set_max_xyz"}]}}]
tellraw @s ["",{translate:"gp.editor.button.set_min_max_tall",color:"yellow",bold:false,click_event:{action:"run_command",command:"/function phan:editor/checkpoint/set_y_tall"},hover_event:{action:"show_text",value:[{translate:"gp.editor.hover.set_min_max_tall"}]}}]
