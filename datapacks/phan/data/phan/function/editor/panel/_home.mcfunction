...
tellraw @s ["",{"translate":"gp.editor.button.nodes","color":"#AAFFAA","bold":false,"clickEvent":{"action":"run_command","value":"/function phan:editor/panel/_spawn"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.editor.hover.nodes"}]}}]
tellraw @s ["",{"translate":"gp.editor.button.ai_waypoints","color":"#AAFFAA","bold":false,"clickEvent":{"action":"run_command","value":"/function phan:editor/panel/_ai_waypoints"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.editor.hover.ai_waypoints"}]}}]
