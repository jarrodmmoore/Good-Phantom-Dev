...
execute as @e[type=marker,tag=AIBC] unless score @s AIBC_id matches -2147483648..2147483647 at @s if loaded ~ ~ ~ run function phan:editor/restore_using_nbt/waypoint_standard