...
summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:420,Tags:["checkpointBound","lowerBound","boundX","setLife"]}
summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:420,Tags:["checkpointBound","lowerBound2","boundX","setLife"]}
summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:420,Tags:["checkpointBound","upperBound","boundX","setLife"]}
summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"block",block_state:{id:"air"}},WaitTime:0,Duration:420,Tags:["checkpointBound","upperBound2","boundX","setLife"]}
...
tag @e[tag=setLife] add loadZoneBound
