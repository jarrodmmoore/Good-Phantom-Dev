...
execute if score #botsEnabled value matches 1.. if score @s attackerID matches 1.. as @e[type=mannequin,tag=ai] if score @s playerID = #attackerID value at @s run function phan:items/ko_get
