$give @s minecraft:cyan_dye[item_model="gp/item_entity/red_rocket",custom_name={translate:"gp.item.red_rocket",color:"red",bold:true,italic:false},custom_data={item:1b,rightclick:1b,redRocket:1b,stay:1b}] $(count)
