...
execute if score #botsEnabled value matches 1.. unless entity @s[tag=lostTarget] as @e[type=mannequin,tag=ai,distance=..10] if score @s playerID = #getID value run tag @s add anvilTarget
