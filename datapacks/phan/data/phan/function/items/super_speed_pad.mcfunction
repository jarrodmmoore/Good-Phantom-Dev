...
execute if score #botsEnabled value matches 1.. unless score @s editArg1 matches 1 positioned ~-.5 ~-2 ~-.5 run damage @e[type=mannequin,tag=ai,dx=1,dy=1,dz=1,limit=1,scores={botMoveState=..2}] 4 mob_attack by @s from @s
...
execute if score #botsEnabled value matches 1.. positioned ~-1 ~-1 ~-1 as @e[type=mannequin,tag=ai,dx=2,dy=2,dz=2] at @s run function phan:bots/movement/speed_pad_super
