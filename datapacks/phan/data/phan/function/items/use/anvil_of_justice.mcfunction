...
execute if score #botsEnabled value matches 1.. run scoreboard players set @e[type=mannequin,tag=ai,scores={botSkill=..5}] botHasItem11 0
execute if score #botsEnabled value matches 1.. run scoreboard players set @e[type=mannequin,tag=ai,scores={botHoldingItem=11}] botHoldingItem 0
