...
execute store result score #botWarping value run execute if entity @s[tag=ai]
...
clear @s[type=player] lime_candle[custom_data~{warp:1b}] 1

#bots needs to update data
