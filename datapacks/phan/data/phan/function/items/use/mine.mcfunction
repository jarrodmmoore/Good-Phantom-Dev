...
scoreboard players set @e[type=item_display,tag=setMe,distance=..4] enemyMaxHP 510
scoreboard players set @e[type=item_display,tag=setMe,distance=..4] enemyHP 510
...
scoreboard players set @e[type=armor_stand,tag=setLife,distance=..4] lifespan 10

#mark mine as human-owned
execute if entity @s[type=player] run tag @e[type=item_display,tag=setMe,distance=..4] add humanOwned

#get ID and validity stuff
scoreboard players operation @e[type=item_display,tag=setMe,distance=..4] playerID = @s playerID
scoreboard players set @e[type=item_display,tag=setMe,distance=..4] itemValidSpawn 1
...
execute as @e[type=armor_stand,tag=setLife,distance=..4] positioned ~ ~.5 ~ run tp @s ~ ~ ~ ~ 0

#join team for glowing color
team join colorRed @e[type=item_display,tag=setMe,distance=..4]
