...
execute if score #gameState value matches 4 if score #gameType value matches 1 run scoreboard players set #math value 90
execute if score #gameState value matches 4 if score #gameType value matches 1 run scoreboard players operation #math value += @s timeBehind1st
