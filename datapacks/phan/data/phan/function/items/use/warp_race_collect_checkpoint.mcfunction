...
execute if score #botWarping value matches 1 as @e[tag=warpingPlayer,type=mannequin,tag=ai] run function phan:items/use/warp_race_collect_checkpoint_transfer_data
