...
summon armor_stand ~ ~1 ~ {Tags:["tickObject","rocket","homing","giveID"],Marker:1b,Invisible:1b,Invulnerable:1b,Passengers:[{id:"minecraft:item_display",brightness:{sky:10,block:15},Tags:["setLife"],teleport_duration:1,item_display:"head",item:{id:"minecraft:cyan_dye",count:1b,components:{"item_model":"gp/item_entity/homing_rocket"}}}]}
