...
execute if score #botsEnabled value matches 1.. run scoreboard players set @e[tag=tntCanHit,tag=ai,type=mannequin,distance=..5,tag=!self] attackTime 100
execute if score #botsEnabled value matches 1.. run scoreboard players set @e[tag=tntCanHit,tag=ai,type=mannequin,distance=..5,tag=!self,tag=!baddy] hitstun 2
execute if score #botsEnabled value matches 1.. run scoreboard players set @e[tag=tntCanHit,tag=ai,type=mannequin,distance=..5,tag=!self,tag=!explosionOwner] hurtfulTime 5
...
execute if entity @s[tag=reflectedProjectile] as @e[tag=tntCanHit,tag=ai,type=mannequin,distance=..5,tag=!self] run function phan:items/generic_explode_friendly_reflect_advancement
#tag clean-up
tag @s remove self