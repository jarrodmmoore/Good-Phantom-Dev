...
execute if score #hasWarp value matches ..0 run tag @e[tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,type=armor_stand,scores={r=1..20}] add tempItemBan
execute if score #hasWarp value matches ..0 run tag 00000000-0000-0328-0000-000000000010 remove tempItemBan