...
execute if score #randomRoll2 value matches 3.. run tag @e[tag=randomize,type=armor_stand,scores={r=15}] add tempItemBan

#1 in 2 chance of not allowing blinding squid at all
execute store result score #randomRoll2 value run random value 1..2
execute if score #randomRoll2 value matches 2.. run tag @e[tag=randomize,type=armor_stand,scores={r=16}] add tempItemBan
...
execute if score #hasTnt value matches 1.. run tag @e[tag=randomize,type=armor_stand,scores={r=4}] add tempItemBan
execute if score #hasSonicBlast value matches 1.. run tag @e[tag=randomize,type=armor_stand,scores={r=7..8}] add tempItemBan
execute if score #hasShield value matches 1.. run tag @e[tag=randomize,type=armor_stand,scores={r=7..8}] add tempItemBan
execute if score #hasSwiftness value matches 1.. run tag @e[tag=randomize,type=armor_stand,scores={r=11..12}] add tempItemBan
...
execute if score @s picksSinceUtility matches ..1 run tag @e[tag=randomize,type=armor_stand,scores={r=7..8}] add tempItemBan
...
execute if score @s picksSinceSpeed matches ..1 run tag @e[tag=randomize,type=armor_stand,scores={r=9..14}] add tempItemBan
...
execute if score @s picksSinceTrap matches ..1 run tag @e[tag=randomize,type=armor_stand,scores={r=5..6}] add tempItemBan

#can't get speed pad if there are too many on the field at once
execute if score #givenPads value matches 6.. run tag @e[tag=randomize,type=armor_stand,scores={r=9..10}] add tempItemBan
