...
execute positioned ~ ~2 ~ rotated as @s rotated ~90 0 as @e[type=armor_stand,tag=giveID,distance=..4] run tp @s ~ ~ ~ ~ ~
scoreboard players operation @e[type=armor_stand,tag=giveID,distance=..4] playerID = @s playerID
scoreboard players operation @e[type=armor_stand,tag=giveID,distance=..4] attackerID = #attackerID value
scoreboard players set @e[type=armor_stand,tag=giveID,distance=..4] lifespan 10
scoreboard players set @e[type=armor_stand,tag=giveID,distance=..4] itemValidSpawn 1
tag @e[type=armor_stand,tag=giveID,distance=..4] remove giveID
