...
execute if score #botsEnabled value matches 1.. as @e[tag=ai,type=mannequin] if score @s playerID = #getID value run tag @s add squidTarget
...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=squidTarget,limit=1] at @s anchored eyes positioned ^ ^ ^5 if loaded ~ ~ ~ run tp @e[type=squid,tag=squidEnt] ~ ~ ~ ~ ~

#stay alive as long as we're following someone
execute if entity @a[tag=squidTarget] run scoreboard players set @s lifespan 5
execute if score #botsEnabled value matches 1.. if entity @e[type=mannequin,tag=squidTarget,limit=1] run scoreboard players set @s lifespan 5
...
execute if score @s age matches 36 if score #botsEnabled value matches 1.. at @s run scoreboard players set @e[tag=squidTarget,type=mannequin] squidBlindTime 56
#die after 3sec
...
execute if score #botsEnabled value matches 1.. run tag @e[tag=squidTarget,type=mannequin] remove squidTarget
