...
execute if score #10Hz value matches 1 if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] unless score @s playerID = #thisEndermanID value run function phan:items/enderman_phase_2_check_mainhand_bot
