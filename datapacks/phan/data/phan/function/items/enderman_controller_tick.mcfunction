...
execute if score @s age matches ..99 if score #botsEnabled value matches 1.. as @e[tag=ai,type=mannequin] if score @s playerID = #thisEndermanID value at @s run function phan:items/enderman_phase_1
...
execute if score @s age matches 500..599 if score #botsEnabled value matches 1.. as @e[tag=ai,type=mannequin] if score @s playerID = #thisEndermanTG value at @s run function phan:items/enderman_phase_3
