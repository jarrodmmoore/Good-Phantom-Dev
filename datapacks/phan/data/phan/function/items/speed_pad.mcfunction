...
execute if score #botsEnabled value matches 1.. positioned ~-1 ~-1 ~-1 as @e[tag=ai,type=mannequin,dx=2,dy=2,dz=2] unless score @s speedBoost2 matches 2 at @s run function phan:bots/movement/speed_pad
