...
execute if score #botsEnabled value matches 1.. as @e[tag=ai,type=mannequin] if score @s playerID = #getID value run scoreboard players operation #test2 value = @s check
