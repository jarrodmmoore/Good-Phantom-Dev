...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] if score @s playerID = #getID value run scoreboard players operation #test2 value = @s check
