...
execute if score #botsEnabled value matches 1.. as @e[type=mannequin,tag=ai] if score @s playerID = #thisEndermanID value run function phan:items/steal_item/give_to_stealer
