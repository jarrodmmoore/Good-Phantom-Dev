...
execute if entity @s[tag=!hasCarrot] run item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick[tooltip_display={hide_tooltip:true},lore=[{translate:"gp.misc.this_detects_right_clicks",color:"#FA66FF",italic:true}],custom_name={translate:"gp.misc.input_detector",bold:true,italic:false,color:"light_purple"},custom_data={input_carrot:1b}] 1