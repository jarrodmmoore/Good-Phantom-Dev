#erase high scores
execute as @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={levelUID=-2147483648..2147483647}] run function phan:high_score/erase_level_scores
