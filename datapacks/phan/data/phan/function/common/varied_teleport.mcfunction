...
execute if score #varyTeleport value matches 2 positioned ~ ~ ~.5 run tp @s ~ ~ ~ ~ ~
execute if score #varyTeleport value matches 3 positioned ~ ~ ~-.5 run tp @s ~ ~ ~ ~ ~
...
execute if score #varyTeleport value matches 6 positioned ~ ~ ~1.5 run tp @s ~ ~ ~ ~ ~
execute if score #varyTeleport value matches 7 positioned ~ ~ ~-1.5 run tp @s ~ ~ ~ ~ ~
