...
execute if score #tvMenuState1 value matches 0 if score #test value matches ..1 as @e[type=text_display,tag=tvSubtitle2,distance=..10] run data modify entity @s text set value '["",{"translate":"gp.phantom_racer.requires_2_players","color":"red","italic":true}]'
execute if score #tvMenuState1 value matches 0 if score #test value matches 2.. as @e[type=text_display,tag=tvSubtitle2,distance=..10] run data modify entity @s text set value '["",{"translate":"gp.phantom_racer.no_bots_players_only","color":"white","italic":true}]'
