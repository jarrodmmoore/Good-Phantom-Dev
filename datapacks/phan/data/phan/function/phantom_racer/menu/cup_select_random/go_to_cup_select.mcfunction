...
execute as @e[type=text_display,tag=tvRandomPanel] run scoreboard players set @s lifespan 0
execute as @e[type=item_display,tag=tvRandomPanelBackground,distance=..10] run data merge entity @s {start_interpolation:-1,interpolation_duration:6,transformation:{scale:[0.0f,0.0f,1.0f]}}
