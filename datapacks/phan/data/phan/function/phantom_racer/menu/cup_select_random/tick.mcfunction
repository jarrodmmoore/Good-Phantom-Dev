...
execute if score #tvAnimation value matches 10.. unless score #tvMenuState9 value = #tvMenuState10 value run function phan:phantom_racer/menu/cup_select_random/update_mode_text

#handle inputs
execute if score #tvCooldown value matches ..0 if score #tvInputUD value matches 1.. run function phan:phantom_racer/menu/generic_select_change_2 {menu_state:5,add:-1,mod:4,cooldown:4}
execute if score #tvCooldown value matches ..0 if score #tvInputUD value matches ..-1 run function phan:phantom_racer/menu/generic_select_change_2 {menu_state:5,add:1,mod:4,cooldown:4}
...
execute if score #tvCooldown value matches ..0 if score #tvMenuState5 value matches 0 if score #tvInputLR value matches ..-1 run function phan:phantom_racer/menu/generic_select_change_minmax {menu_state:7,add:-1,min:1,max:50,cooldown:2}
execute if score #tvCooldown value matches ..0 if score #tvMenuState5 value matches 1 if score #tvInputLR value matches 1.. run function phan:phantom_racer/menu/generic_select_change_2 {menu_state:9,add:1,mod:3,cooldown:4}
execute if score #tvCooldown value matches ..0 if score #tvMenuState5 value matches 1 if score #tvInputLR value matches ..-1 run function phan:phantom_racer/menu/generic_select_change_2 {menu_state:9,add:-1,mod:3,cooldown:4}
