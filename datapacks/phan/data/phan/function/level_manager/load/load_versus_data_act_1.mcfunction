...
#time limit
execute store result score #vMinTimeLimit value run data get storage phan_dream_active:pr_act_1 time_limit
execute store result score #vTimeLimit value run data get storage phan_dream_active:pr_act_1 time_limit_minimum
