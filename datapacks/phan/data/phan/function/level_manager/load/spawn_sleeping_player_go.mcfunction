...
$summon armor_stand ~ ~ ~ {Tags:["lobbyProp","lobbyPlayer$(spawn_player_uid)","levelEntry"],Marker:1b,Silent:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Pose:{Head:$(spawn_player_head_rotation)},ArmorItems:[{},{},{},{id:"minecraft:red_wool",count:1,components:{"item_model":"$(spawn_player_model)"}}]}
