...
# [Score Attack]
tellraw @a[tag=tellMe] ["",{"translate":"gp.misc.brackets","color":"yellow","bold":false,"with":[{"translate":"gp.mode_select.score_attack"}],"clickEvent":{"action":"run_command","value":"/function phan:level_manager/panel/score_attack/_menu_lookup"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.mode_select.score_attack"}]}},{"text":"  "},{"translate":"gp.level_manager.selectable_status","color":"gray","with":[{"score":{"name":"#test2","objective":"value"}}]}]
# [Portal Race]
...
# [Import] [Export]
tellraw @a[tag=tellMe] ["",{"text":" "}]
tellraw @a[tag=tellMe] ["",{"translate":"gp.misc.brackets","color":"green","bold":false,"with":[{"translate":"gp.level_manager.import_dream_data"}],"clickEvent":{"action":"suggest_command","value":"/function phan:level_manager/import_dream {filename:'filename'}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.level_manager.import_dream_data"}]}},{"text":"  "},{"translate":"gp.misc.brackets","color":"green","bold":false,"with":[{"translate":"gp.level_manager.export_dream_data"}],"clickEvent":{"action":"suggest_command","value":"/function phan:level_manager/export_dream {filename:'filename'}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.level_manager.export_dream_data_with_tip"}]}}]
