...
#selectable y/n
execute if entity @s[tag=levelSelectable] run tellraw @a[tag=tellMe] ["",{"translate":"gp.level_manager.selectable","bold":true},{"text":"  "},{"translate":"gp.misc.brackets","color":"yellow","bold":false,"with":[{"translate":"gp.misc.yes"}],"clickEvent":{"action":"run_command","value":"/function phan:level_manager/set_field {resource_location:'dream_data',nbt:'selectable',value:1}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.misc.yes"}]}},{"text":" "},{"translate":"gp.misc.brackets","color":"gray","bold":false,"with":[{"translate":"gp.misc.no"}],"clickEvent":{"action":"run_command","value":"/function phan:level_manager/set_field {resource_location:'dream_data',nbt:'selectable',value:0}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.misc.no"}]}}]
execute if entity @s[tag=!levelSelectable] run tellraw @a[tag=tellMe] ["",{"translate":"gp.level_manager.selectable","bold":true},{"text":"  "},{"translate":"gp.misc.brackets","color":"gray","bold":false,"with":[{"translate":"gp.misc.yes"}],"clickEvent":{"action":"run_command","value":"/function phan:level_manager/set_field {resource_location:'dream_data',nbt:'selectable',value:1}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.misc.yes"}]}},{"text":" "},{"translate":"gp.misc.brackets","color":"yellow","bold":false,"with":[{"translate":"gp.misc.no"}],"clickEvent":{"action":"run_command","value":"/function phan:level_manager/set_field {resource_location:'dream_data',nbt:'selectable',value:0}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.misc.no"}]}}]
#function namespace
...
$tellraw @a[tag=tellMe] ["",{"translate":"gp.level_manager.sleeping_player_model","bold":true},{"text":"  "},{"translate":"gp.misc.brackets","color":"light_purple","bold":false,"with":[{"translate":"gp.misc.set"}],"clickEvent":{"action":"suggest_command","value":"/function phan:level_manager/set_field {resource_location:'dream_data',nbt:'sleeping_player_model',value:'gp/object/sleeping_player_1'}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.misc.set"}]}},{"text":"  "},{"nbt":"sleeping_player_model","storage":"phan_dream_$(level_id):dream_data","interpret":false}]
#name text
...
#name display
#(i will do a backflip if this actually works)
tellraw @a[tag=tellMe] ["",{"text":"\n\n"}]
$tellraw @a[tag=tellMe] ["",{"translate":"gp.level_manager.sleeping_player_model","bold":true},{"text":"  "},{"translate":"gp.misc.brackets","color":"light_purple","bold":false,"with":[{"translate":"gp.misc.set"}],"clickEvent":{"action":"suggest_command","value":"/function phan:level_manager/set_field {resource_location:'dream_data',nbt:'name_display',value:'[\"\",{\"text\":\"\\uE399\",\"color\":\"white\"}]'}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.misc.set"}]}},{"text":"  "},{"nbt":"name_display","storage":"phan_dream_$(level_id):dream_data","interpret":true}]
