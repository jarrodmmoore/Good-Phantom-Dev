...
$tellraw @a[tag=tellMe] ["",{"translate":"gp.level_manager.sleeping_player_model","bold":true},{"text":"  "},{"translate":"gp.misc.brackets","color":"light_purple","bold":false,"with":[{"translate":"gp.misc.set"}],"clickEvent":{"action":"suggest_command","value":"/function phan:level_manager/set_field_and_resummon {resource_location:'dream_data',nbt:'sleeping_player_model',value:'gp/object/sleeping_player_steve'}"},"hoverEvent":{"action":"show_text","value":[{"translate":"gp.misc.set"}]}},{"text":"  "},{"nbt":"sleeping_player_model","storage":"phan_dream_$(level_id):dream_data","interpret":false}]
#name text
