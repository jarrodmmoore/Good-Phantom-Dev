...
execute as @e[tag=levelEntry,type=armor_stand] if score @s levelUID = #checkID value run function phan:level_manager/panel/score_attack/act/_menu_2 with storage phan:level_index