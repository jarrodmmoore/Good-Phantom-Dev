...
execute as @e[type=armor_stand,tag=levelEntry] if score @s levelUID = #checkID value run function phan:level_manager/panel/score_attack/act/_menu with storage phan:level_index