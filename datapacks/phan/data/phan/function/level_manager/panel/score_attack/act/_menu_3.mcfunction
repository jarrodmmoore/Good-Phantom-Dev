...
$tellraw @a[tag=tellMe] ["",{text:"===\\/=== ",bold:true,color:"yellow"},{selector:"@s"},{text:" | "},{nbt:"act_name",storage:"phan_dream_$(level_id):sa_act_$(act)",interpret:true},{text:" ===\\/===",bold:true,color:"yellow"}]
