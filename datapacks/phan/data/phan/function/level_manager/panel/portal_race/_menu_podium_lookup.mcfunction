...
execute as @e[tag=levelEntry,type=armor_stand] if score @s levelUID = #checkID value run function phan:level_manager/panel/portal_race/_menu_podium with storage phan:level_index