...
#page number
tellraw @a[tag=tellMe] ["",{text:" "},{translate:"gp.level_manager.page_x_of_x",with:[{text:"3"},{text:"3"}],italic:true},{text:"  "},{text:"[<<]",color:"yellow",bold:false,click_event:{action:"run_command",command:"/function phan:level_manager/panel/portal_race/act/_menu_2_lookup"},hover_event:{action:"show_text",value:[{translate:"gp.misc.previous"}]}},{text:" "},{text:"[>>]",color:"dark_gray",bold:false,click_event:{action:"run_command",command:"/function phan:level_manager/error_noise"},hover_event:{action:"show_text",value:[{translate:"gp.misc.next"}]}}]
