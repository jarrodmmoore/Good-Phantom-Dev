...
execute as @e[type=armor_stand,tag=levelEntry] if score @s levelUID = #checkID value run function phan:level_manager/panel/portal_race/_menu with storage phan:level_index