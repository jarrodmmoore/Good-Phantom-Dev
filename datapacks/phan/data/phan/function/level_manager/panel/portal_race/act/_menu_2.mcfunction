...
$execute if score #musicTrackSA value matches -1.. run tellraw @a[tag=tellMe] ["",{"translate":"gp.level_manager.music_function","bold":true,"color":"gray"},{"text":"  "},{"nbt":"music_function","storage":"phan_dream_$(level_id):pr_act_$(act)","interpret":false,"color":"gray"}]
#reset_plane
