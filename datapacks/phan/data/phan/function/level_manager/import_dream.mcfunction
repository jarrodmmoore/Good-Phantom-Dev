...
execute if score #mapVersionRead value matches ..102004 run function phan:level_manager/import_dream_v1_2_4_go with storage phan:level_index
execute if score #mapVersionRead value matches 102005.. run function phan:level_manager/import_dream_go with storage phan:level_index
