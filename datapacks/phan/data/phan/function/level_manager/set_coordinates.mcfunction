...
$data modify storage phan:level_index x set value $(x)
$data modify storage phan:level_index y set value $(y)
$data modify storage phan:level_index z set value $(z)

#do it
execute store result storage phan:level_index level_id int 1 run scoreboard players get @s levelUID
function phan:level_manager/set_coordinates_go with storage phan:level_index
