#find next waypoint
execute store result storage phan:bot_args id int 1 run scoreboard players get #waypointModifierRepeat value
...
execute if score #test value matches 0 run function phan:bots/behaviors/1_follow_waypoints/event/13_mine_logic/go_set_mine_later
