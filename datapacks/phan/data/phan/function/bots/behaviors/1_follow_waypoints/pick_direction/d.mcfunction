...
execute unless score #wpRestrictDirections value matches 1.. if score #wpRestrictDirectionsBT value matches 1.. run function phan:bots/behaviors/1_follow_waypoints/pick_direction/d_restrict_backtrack
