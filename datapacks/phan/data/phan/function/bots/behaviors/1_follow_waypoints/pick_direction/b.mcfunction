...
execute if score #waypointDir2 value matches 1.. in overworld run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=4..16}] add directionViable
execute if score #waypointDir3 value matches 1.. in overworld run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=17..19}] add directionViable
