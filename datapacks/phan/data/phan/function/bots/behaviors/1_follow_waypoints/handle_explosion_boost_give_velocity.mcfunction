...
#teleport facing target
execute at @s facing entity 00000309-0000-0000-0000-00000000000f feet rotated ~ ~-30 run tp @s ~ ~ ~ ~ ~
...
execute facing entity 00000309-0000-0000-0000-00000000000f feet if loaded ^ ^ ^0.00075 run summon marker ^ ^ ^0.00075 {UUID:[I;777,0,0,1]}
