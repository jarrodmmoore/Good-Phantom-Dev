...
execute if score @s botApproachX matches 11.. if score #testX value matches ..16 run scoreboard players set @s botApproachX 0
execute if score @s botApproachX matches ..-11 if score #testX value matches -16.. run scoreboard players set @s botApproachX 0
execute if score @s botApproachX matches -10..10 run scoreboard players add #test value 1

execute if score @s botApproachZ matches 11.. if score #testZ value matches ..16 run scoreboard players set @s botApproachZ 0
execute if score @s botApproachZ matches ..-11 if score #testZ value matches -16.. run scoreboard players set @s botApproachZ 0
