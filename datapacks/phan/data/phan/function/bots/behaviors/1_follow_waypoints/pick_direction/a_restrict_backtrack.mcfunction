...
execute if score #wpAllowDirBT1 value matches ..0 in overworld run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=1..13}] remove directionViable
execute if score #wpAllowDirBT2 value matches ..0 in overworld run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=14..16}] remove directionViable
