...
execute positioned ~-10 ~-10 ~-10 as @e[type=marker,tag=AIBC,tag=!AIBC_midAir,dx=20,dy=13,dz=20,limit=7,sort=nearest] positioned ~10 ~10 ~10 run function phan:bots/behaviors/1_follow_waypoints/reroute_check_los_start
