...
execute if score #waypointHook value matches 1 run scoreboard players set @s botHookBase 20
...
execute if score #waypointHook value matches 2 run scoreboard players set @s botHookBase -20
...
execute if score #waypointHook value matches 3 store result score @s botHookBase run random value 0..40
execute if score #waypointHook value matches 3 run scoreboard players remove @s botHookBase 20
