#we need to rotate the mannequin back to the rotation it had last tick
#otherwise minecraft will throw a wrench in our plans on EVERY GAME TICK (the audacity)
