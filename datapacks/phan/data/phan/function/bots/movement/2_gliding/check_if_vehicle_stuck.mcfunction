...
execute if score #testX value matches 0 if score #testY value matches -8..0 if score #testZ value matches 0 run scoreboard players add @s botTimeSinceFlightProgress 1
