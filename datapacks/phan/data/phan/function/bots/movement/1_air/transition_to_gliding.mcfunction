...
#summon armor_stand ~ ~ ~ {Tags:["botElytra","setMe"],Small:0b,FallFlying:1b,Silent:1b,Invisible:1b,NoBasePlate:1b,Invulnerable:1b,DisabledSlots:4144959,ArmorItems:[{},{},{id:"minecraft:elytra",count:1,components:{"minecraft:unbreakable":{}}},{}],attributes:[{id:"minecraft:generic.scale",base:0.0625}]}
...
#get rid of elytra in chest slot temporarily
