...
#add onto initial velocity somewhat depending on skill level (unless we're vaulting upward, in which case don't change speed)
...
execute unless score @s botVaultUpwardTime matches 1.. run function phan:bots/movement/2_gliding/apply_velocity_to_vehicle_variable with storage phan:coords
