...
#hard+ bots won't drink if they're airborne or gliding
execute if score @s botSkill matches 4.. if score @s botMoveState matches 1..2 run return run scoreboard players set @s botHoldingItem 0
