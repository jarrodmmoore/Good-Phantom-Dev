...
execute if score @s botSkill matches ..1 run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=4..10}] add improvViable
execute if score @s botSkill matches 2 run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=4..9}] add improvViable
execute if score @s botSkill matches 3 run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=4..7}] add improvViable
execute if score @s botSkill matches 4 run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=4..5}] add improvViable
...
execute if score @s botSkill matches ..1 if score #gameTime value matches ..820 run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=11..26}] add improvViable
execute if score @s botSkill matches 2 if score #gameTime value matches ..720 run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=11..22}] add improvViable
execute if score @s botSkill matches 3 if score #gameTime value matches ..620 run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=11..18}] add improvViable
execute if score @s botSkill matches 4 if score #gameTime value matches ..620 run tag @e[type=armor_stand,tag=randomize,x=-1,y=-64,z=-1,dx=1,dy=1,dz=1,scores={r=11..16}] add improvViable
