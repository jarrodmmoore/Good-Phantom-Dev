...
execute if score @s botSkill matches ..3 run scoreboard players set @s botHoldingItem 2
...
data modify storage phan:coords functioncall set value "phan:bots/items/2_homing_rocket/use"
...
execute facing entity 0001e453-0000-0000-0000-000000000004 eyes rotated ~ ~-1 run function phan:bots/items/shoot_projectile_with_aim_offset with storage phan:coords
