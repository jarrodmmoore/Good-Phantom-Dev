...
tag @s add thinkSelf
execute if score #vGameType value matches 1 if entity @e[type=mannequin,tag=botRival,tag=!thinkSelf,scores={botSkill=5..,racePosDisplay=1}] unless score #1stPlaceLeadTime value matches 100.. run return run tag @s remove thinkSelf
