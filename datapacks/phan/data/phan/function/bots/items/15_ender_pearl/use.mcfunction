...
execute store result entity @e[limit=1,type=ender_pearl,tag=giveVel,distance=..4] Motion[0] double 0.0156 run scoreboard players get #coord_dx value
execute store result entity @e[limit=1,type=ender_pearl,tag=giveVel,distance=..4] Motion[1] double 0.0156 run scoreboard players get #coord_dy value
execute store result entity @e[limit=1,type=ender_pearl,tag=giveVel,distance=..4] Motion[2] double 0.0156 run scoreboard players get #coord_dz value
tag @e[type=ender_pearl,tag=giveVel,limit=1,distance=..4] remove giveVel
...
scoreboard players set @e[limit=1,type=ender_pearl,tag=giveID,distance=..4] itemValidSpawn 1

#we did this. it was us.
scoreboard players operation @e[limit=1,type=ender_pearl,tag=giveID,distance=..4] playerID = @s playerID
