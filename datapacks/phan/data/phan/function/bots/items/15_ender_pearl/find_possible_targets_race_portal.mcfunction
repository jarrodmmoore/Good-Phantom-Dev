...
execute as @e[type=marker,tag=portalCore,scores={versusSpawn=1},distance=..70] facing entity @s eyes rotated ~ ~-45 run function phan:bots/items/15_ender_pearl/pearl_check_los_start_direct
execute if score #targetExists value matches 1.. run return 0
