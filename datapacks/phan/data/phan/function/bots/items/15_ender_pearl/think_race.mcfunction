...
execute if entity @s[tag=!vsHomeStretch] anchored eyes rotated ~ 0 run function phan:bots/items/15_ender_pearl/find_possible_targets_race with storage phan:bot_args
...
execute if entity @s[tag=!vsHomeStretch] facing entity @e[limit=1,sort=nearest,tag=viableTarget,type=marker,distance=..72] eyes rotated ~ -35 run function phan:bots/items/15_ender_pearl/use
