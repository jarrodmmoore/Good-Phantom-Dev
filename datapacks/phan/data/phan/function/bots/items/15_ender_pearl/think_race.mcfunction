...
#(using "positioned ~ ~1.8 ~" because "anchored eyes" is unreliable)
...
execute if score #rot_pitch value matches -15 facing entity @e[limit=1,sort=nearest,tag=viableTarget,type=marker,distance=..72] feet rotated ~ ~-15 run function phan:bots/items/15_ender_pearl/use
execute if score #rot_pitch value matches -25 facing entity @e[limit=1,sort=nearest,tag=viableTarget,type=marker,distance=..72] feet rotated ~ ~-25 run function phan:bots/items/15_ender_pearl/use
execute if score #rot_pitch value matches -35 facing entity @e[limit=1,sort=nearest,tag=viableTarget,type=marker,distance=..72] feet rotated ~ ~-35 run function phan:bots/items/15_ender_pearl/use
execute if score #rot_pitch value matches -45 facing entity @e[limit=1,sort=nearest,tag=viableTarget,type=marker,distance=..72] feet rotated ~ ~-45 run function phan:bots/items/15_ender_pearl/use
