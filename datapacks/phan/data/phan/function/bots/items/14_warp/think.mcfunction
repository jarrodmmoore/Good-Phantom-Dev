...
execute if score #vGameType value matches 1 if entity @s[scores={botSkill=2,itemLuck=..4}] run return 0
execute if score #vGameType value matches 1 if entity @s[scores={botSkill=3,itemLuck=..3}] run return 0
