...
execute unless score #botPreparedToBoostTrap value matches 1.. unless score #botBoostTime value matches 1.. if score #botSkill value matches 3.. if score #targetExists value matches 0 positioned ^ ^ ^5 if entity @s[type=item_display,tag=enemyMine,distance=..4] positioned ^ ^ ^-5 run function phan:bots/reaction/mine
#=====