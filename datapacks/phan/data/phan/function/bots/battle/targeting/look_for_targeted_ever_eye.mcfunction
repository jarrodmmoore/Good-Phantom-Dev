...
execute as @e[type=item_display,tag=enderEye,distance=..30] if score @s eyeSpawnerID = #checkID value facing entity @s feet run scoreboard players set #targetExists value 1
