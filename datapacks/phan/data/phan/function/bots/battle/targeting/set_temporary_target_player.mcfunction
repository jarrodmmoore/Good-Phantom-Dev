...
scoreboard players operation #botTargetID value = @s playerID
execute as @e[type=mannequin,tag=botSelf,distance=..1] run function phan:bots/reaction/set_temporary_target_go